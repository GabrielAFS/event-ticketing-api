...
--
-- Host: 127.0.0.1    Database: event_ticketing
-- ------------------------------------------------------
...
CREATE TABLE `event` (
  ...
  `numberOfTickets` int NOT NULL DEFAULT '0',
...
--
-- Dumping routines for database 'event_ticketing'
--
...
-- Dump completed on 2025-03-26 16:33:41
